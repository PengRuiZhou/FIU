...
> **Date**: 2026-06-15
> **Status**: ✅ 已修复（2026-06-16，方案 A + replay 手术式补齐，见 2026-06-16-tickfile-stale-fix-design.md）
...
> **2026-06-16 更新**: 已实施方案 A（shutdown/cross-day 跳过未到分钟）+ Part 2（replay 手术式补齐）。详见 2026-06-16-tickfile-stale-fix-design.md。
